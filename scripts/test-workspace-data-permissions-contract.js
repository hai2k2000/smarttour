...
includes("const canViewDebtReports = hasPermission(user, 'finance.debt.view');", 'Workspace data should calculate debt report permission before loading debt rows.');
...
includes("canViewFinanceReports && canViewDebtReports ? apiGet<WorkspaceFinance>('/api/reports/finance?dateField=documentDate&financeView=customer-debt'", 'Workspace should not fetch debt-bearing finance report without finance.cashflow.view and finance.debt.view.');
