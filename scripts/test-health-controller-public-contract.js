...
assert(source.includes('Header'), 'HealthController must import Header decorator');
...
assert(/@Public\(\)\s*@Header\('Cache-Control', 'no-store'\)\s*@Get\(\)/.test(source), 'HealthController health route must be public and no-store for external monitoring');
