...
[
  ...
  'FAIL_OPS_LOG_PERMS',
  'exposed_ops_log="$(run_audit_file_scan /var/log/smarttour -maxdepth 1 -type f',
  'exposed_security_report="$(run_audit_file_scan /var/log/smarttour/security -maxdepth 1 -type f',
  ...
  'exposed_file="$(run_audit_file_scan "$dir" -maxdepth 1 -type f',
  'FAIL_BACKUP_PERMS',
  'check_disaster_backup_staging_dirs()',
  "run_audit_file_scan /var/backups/smarttour/disaster -maxdepth 1 -type d -name 'smarttour-disaster-*'",
...
[
  'if docker ps --format',
  'exposed_file="$(find "$dir"',
  'staging_dir="$(find /var/backups/smarttour/disaster',
  'exposed_ops_log="$(find /var/log/smarttour',
  'exposed_security_report="$(find /var/log/smarttour/security',
