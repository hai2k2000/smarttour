...
const xlsxHelper = read('apps/api/src/modules/finance/finance-xlsx.ts');
...
includes(financeImport, "from './finance-xlsx'", 'Finance import must use the native XLSX helper.');
...
includes(financeService, "from './finance-xlsx'", 'Finance service must use native XLSX export helper.');
...
includes(financeController, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", 'Finance controller must set XLSX content type.');
