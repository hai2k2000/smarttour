    ...
    <section className="workspace">
      <header className="pageHeader">
        ...
        <section className="contentGrid landGrid">
          <div className="panel">
            <h2><Plus size={18} /> Tao LandTour / Combo</h2>
            <form action={createLandTour} className="formGrid landForm">
              ...
              <label>Lich trinh<input name="itinerarySummary" placeholder="Land + phong + xe" /></label>
              ...
              <label>Gia xac nhan<input name="operationUnitPrice" type="number" min={0} defaultValue={0} /></label>
              <label>VAT operation %<input name="operationVat" type="number" min={0} defaultValue={0} /></label>
              <label>Trang thai DV<select name="operationStatus" defaultValue="WAITING"><option>WAITING</option><option>REQUESTED</option><option>CONFIRMED</option><option>OPERATING</option><option>COMPLETED</option><option>CANCELLED</option></select></label>
              ...
              <label>Ghi chu xac nhan<textarea name="confirmationNote" rows={3} /></label>
              <button type="submit">Tao LandTour</button>
            </form>
          </div>

          <div className="panel landSummary">
            <h2><Route size={18} /> Tong quan Land</h2>
        ...
        <section className="panel listPanel">
          ...
          <table>
            <thead><tr><th>Ma</th><th>Tour</th><th>Khach</th><th>Ngay di</th><th>Loai combo</th><th>Guide</th><th>Trang thai</th><th>DV</th><th>DK</th></tr></thead>
            <tbody>
              {tours.map((tour) => (
                <tr key={tour.id}>
              ...
              {tours.length === 0 ? <tr><td colSpan={9}>Chua co LandTour / Combo.</td></tr> : null}
            </tbody>
          </table>
        </section>
    </section>
